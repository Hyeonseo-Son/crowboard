 ...
 */
 ...
 function key_to_signal() {
     if ((keyboard === 'left') || (keyboard === 'right') || (keyboard === 'up') || (keyboard === 'down') || (keyboard === 'w') || (keyboard === 's') || (keyboard === 'd') || (keyboard === 'a') || (keyboard === 'z') || (keyboard === 'o') || (keyboard === 'x') || (keyboard === 'f4') || (keyboard === 'f5') || (keyboard === 'f6') || (keyboard === 'f7') || (keyboard === 'f8') || (keyboard === 'f9') || (keyboard === 'f10') || (keyboard === 'f11') || (keyboard === 'f12') || (keyboard === 'f') || (keyboard === 'g') || (keyboard === 'h') || (keyboard === 't') || (keyboard === 'j') || (keyboard === 'k') || (keyboard === 'l')) {
         if ((keyboard === 'a') || (keyboard === 'd')) { // Yaw
             ...
             ch20_key();  // Gimbal Modewwss
         } else if ((keyboard === 'f8')) {
             ch21_key();  // Capture
         } else if ((keyboard === 'f9')) {
             ch22_key();  // Change Display
         } else if ((keyboard === 'f10')) {
             ch23_key();  // Tracking
         } else if ((keyboard === 'f11')) {
             ch24_key();  // Power ON/OFF
         } else if ((keyboard === 'f12')) {
             ch25_key();  //
         }
     } else {
         ch1 = TRIM;
 ...
 function ch10_key() {
     if ((parseInt(ch10) >= parseInt(MIN)) && (parseInt(ch10) <= parseInt(MAX))) {
         if (keyboard === 'f6') {
             ch10_count++;
             setTimeout(function () {
                 if (ch10_count === 1) {
                     ch10 = MIN;
                 } else if (ch10_count === 2) {
                     ch10 = TRIM;
                 } else if (ch10_count === 3) {
                     ch10 = MAX;
                 } else {
                 }
                 ch10_count = 0;
 ...
 global.ch17_target_val = MIN;
 global.ch18_target_val = MIN;
 global.ch19_target_val = MIN;
 ...
 function channel_val() {
     ...
     rxbuf += hex_crc;
     // console.log(rxbuf);
     MSW_mobius_mqtt_client.publish('/Mobius/KETI_MUV/RC_Data/CROW_RC', Buffer.from(rxbuf, 'hex'))
 }
